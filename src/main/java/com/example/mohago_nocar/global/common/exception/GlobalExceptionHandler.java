...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<?>> handleMethodArgumentNotValidException(
        ...
        ApiResponse<Map<String, String>> response = ApiResponse.onFailure(GlobalStatus.BAD_REQUEST.getCode(), GlobalStatus.BAD_REQUEST.getMessage(), errors);
    ...
    public ResponseEntity<ApiResponse<?>> unexpectedException(
        ...
        Body body = GlobalStatus.INTERNAL_SERVER_ERROR.getBody();
